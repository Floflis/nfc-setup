...
unzip include/ACS-Unified-PKG-Lnx-118-P.zip
echo "Installing NFC drivers for Acr122u-a9..."
...
cp -f include/img/nfctools.svg /usr/share/icons/hicolor/scalable/apps/
ln -sf nfctools.svg /usr/share/icons/hicolor/scalable/apps/nfctoolsgui.svg
include/./nfctools-latest.AppImage --appimage-extract
mv squashfs-root nfctools
$maysudo rsync -av nfctools/. /1/programs/nfctools
